...
extension UserTestQuestionStruct {
    static func dummy() -> [UserTestQuestionStruct] {
        return [
            ...
            UserTestQuestionStruct(testIndex: 2, testTitle: "여행을 가게 되면 먼저 할 일은?", testText: UserTestText(firstQuest: "예약 가능한 비행기 표와 숙소 알아보기", secondQuest: "다른 사람이 다녀온 여행 후기 찾아보기", thirdQuest: "현지에서만 먹을 수 있는 음식 찾아보기", fourthQuest: "여기에서만 할 수 있는 액티비티 찾아보기")),
            ...
            UserTestQuestionStruct(testIndex: 5, testTitle: "친구가 하루만 혼자 놀겠다 하면?", testText: UserTestText(firstQuest: "하고 싶은 걸 물어보고 친구에게 맞춘다", secondQuest: "보내주지만 속으로는 불만이 있을까 걱정한다", thirdQuest: "'하고 싶은 게 있나 보다' 생각하며 보내준다", fourthQuest: "그럼 오늘은 각자 시간을 보내자고 제안한다")),
