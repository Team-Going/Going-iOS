...
extension UserTypeTestResultAppData {
    static func dummy() -> [UserTypeTestResultAppData] {
        return [
            ...
            .init(userType: "계획 절대 지켜 꼼꼼잉", userTypeDesc: "여행의 처음부터 끝까지 착실하게 계획해요",
