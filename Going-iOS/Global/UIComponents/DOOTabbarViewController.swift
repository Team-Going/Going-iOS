...
final class DOOTabbarViewController: UITabBarController {
    ...
    public override func viewDidLoad() {
        ...
        ourTODoVC.tabBarItem.imageInsets = UIEdgeInsets(top: 10, left: 0, bottom: -22, right: -5)
        ...
        myToDoVC.tabBarItem.imageInsets = UIEdgeInsets(top: 10, left: -5, bottom: -22, right: 0)
